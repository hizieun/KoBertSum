...
if __name__ == '__main__':
    ...
    parser.add_argument("-target_summary_sent", default='ext', type=str) # default : abs -> ext
...
#         os.system(f"python make_data.py -task train_bert -target_summary_sent abs -n_cpus {args.n_cpus}")
    ...
    # python main.py -task train -target_summary_sent abs -visible_gpus 0 -train_from 1209_1236/model_step_7000.pt 
        ...
        print("BERT_DATA_DIR = ", BERT_DATA_DIR)
        do_str = f"python train.py -task {args.target_summary_sent} -mode train"  \
...
#         param3 = " -ext_dropout 0.1 -max_pos 512 -lr 2e-3 -warmup_steps 10000 -batch_size 3000 -accum_count 2 -train_steps 50000  -use_interval true"  
        # OOM -> batch-size 수정
        param1 = " -ext_dropout 0.1 -lr 2e-3 -batch_size 300 -train_steps 5000 -accum_count 2 -use_interval true -warmup_steps 3000 -max_pos 512"
        param2 = " -ext_dropout 0.1 -lr 2e-3 -batch_size 600 -train_steps 5000 -accum_count 2 -use_interval true -warmup_steps 3000 -max_pos 512"
        param3 = " -ext_dropout 0.1 -max_pos 512 -lr 2e-3 -warmup_steps 10000 -batch_size 1800 -accum_count 2 -train_steps 50000  -use_interval true"  
        do_str += param3
